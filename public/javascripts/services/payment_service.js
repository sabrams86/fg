app.factory('PaymentService', ['$http', '$cookies', '$window', function ($http, $cookies, $window) {
  ...
  VenmoPayment.makePayment = function (payload) {
    return $http.post('http://quiet-atoll-7804.herokuapp.com/makePayment', payload).then(function (result) {
      console.log(result);
    })
  }
  ...
  VenmoPayment.payWithVenmo = function (payload) {
    console.log(payload);
    return $http.post('http://quiet-atoll-7804.herokuapp.com/venmoLogin', payload).then(function (result) {
